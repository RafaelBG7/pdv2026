...
def validate_production(values, validate_secrets=True):
    ...
    if values.get('PUBLIC_BASE_URL') != 'https://skygest.com.br':
        errors.append('PUBLIC_BASE_URL de produção deve usar skygest.com.br')
    if values.get('MARKETING_BASE_URL') != 'https://skygest.com.br':
