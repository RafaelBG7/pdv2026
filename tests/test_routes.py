...
class RouteTestCase(unittest.TestCase):
    ...
    def test_login_page_loads(self):
        ...
        self.assertIn('href="http://localhost/#funcionalidades"'.encode(), response.data)
        self.assertIn('href="http://localhost/#planos"'.encode(), response.data)
        self.assertIn('href="http://localhost/" aria-label="SkyGest, voltar para a página inicial"'.encode(), response.data)
    ...
    def test_product_form_uses_responsive_sections_and_remote_kit_search(self):
        ...
        self.assertEqual(response.data.count(b'data-replace-zero-on-input'), 2)
